...
let url = `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=a1ead7b1012f3335e53baf5a76134ce5` 
...
return(
    ...
    <div className="fondo">
    <div  className=" flex-col max-w-sm mx-auto  w-96 bg-white bg-opacity-20">
 
    { data ? 
    <article className=" max-h-full flex-col content-center justify-center text-center text-black pt-10">
     <img className="max-w-1/4 max-h-1/4 inline " src={data.weather[0].description === "few clouds" ? partlyCloudy : 
        ...
        <section className="flex self-center justify-around content-center  rounded mx-6 my-4 py-4 px-4 bg-white bg-opacity-70 z-20  "> 
            <div className="flex-col w-16">
                <img className="max-w-1/2 max-h-1/2 inline"  src={temperatur} alt="description"/>
                <h3 className="text-black">{Math.trunc((data?.main.temp)-273.15)+"º"}</h3>
            </div>
            <div className="flex-col w-16">
                <img className="max-w-1/2 max-h-1/2 inline" src={humidite} alt="description"/>
                <h3 className="text-black">{data?.main.humidity}</h3> 
            </div>
            <div className="flex-col w-16">
                <img className="max-w-1/2 max-h-1/2 inline" src={speedd} alt="description"/>
                <h3 className="text-black">{data?.wind.speed}km</h3>
            </div>
        </section>
        <section className="flex-col  rounded top-20  my-0 py-4 px-4  -mt-20 bg-whiteAplha ">
            ...
            <div className="flex justify-between items-center my-4">
                <h3 className="w-32 text-left" >Temperatura máxima</h3>
            ...
            <div className="flex justify-between items-center my-4">
                <h3  className="w-32 text-left" >Temperatura miníma</h3>
            ...
            <div className="flex justify-between items-center my-4">
                <h3 className="w-32 text-left" >Sensación agradable</h3>
